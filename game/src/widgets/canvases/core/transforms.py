...
def padded_fit_uniform_reverse(points: list[tuple[float, float]], in_bl: tuple[float, float],
    ...
    return affine(points, fitted_bl, fitted_tr, in_bl, in_tr)

def zoom_and_pan(points: list[tuple[float, float]], scale: float, offset: tuple[float, float]) -> list[tuple[float, float]]:
    '''
...
def zoom_and_pan_reverse(points: list[tuple[float, float]], scale: float, offset: tuple[float, float]) -> list[tuple[float, float]]:
    tx, ty = offset
    s = scale
